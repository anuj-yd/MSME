...
function UserDashboardPage() {
  ...
  return (
      ...
      right={
        <div className="flex items-center gap-2">
          <a
            ...
            className="hidden rounded-xl border border-primary-100 bg-primary-50 px-3 py-2 text-sm font-semibold text-primary-700 hover:bg-primary-100 md:inline-flex shadow-sm"
          >
            Renewal Guide
          </a>
          <a
            href="#/"
            className="hidden rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-800 hover:bg-slate-50 md:inline-flex shadow-sm"
          >
            Landing
          </a>
          <button
            ...
            className="rounded-xl border border-rose-200 bg-white px-3 py-2 text-sm font-semibold text-rose-600 hover:bg-rose-50 shadow-sm"
          >
            Logout
          </button>
        </div>
    ...
    >
      {loading.bootstrap ? (
        <div className="rounded-2xl border border-slate-200 bg-white/70 backdrop-blur-md p-6 shadow-sm flex items-center justify-center">
          <div className="text-slate-600 font-medium">Loading your dashboard…</div>
        </div>
      ) : errors.bootstrap ? (
        <div className="rounded-2xl border border-rose-200 bg-rose-50/80 backdrop-blur-md p-6 text-rose-700 shadow-sm">
          {errors.bootstrap}
          <div className="mt-4">
            <button
              onClick={() => {
                  ...
                  <button
                    ...
                    className={`flex items-center gap-3 px-4 py-3.5 rounded-2xl text-sm font-bold transition-all duration-300 whitespace-nowrap ${
                      activeTab === tab.id
                        ...
                        : 'bg-white/60 text-slate-600 hover:bg-white hover:text-slate-900 border border-white/60 hover:border-slate-200 hover:shadow-sm scale-95 hover:scale-100'
                    }`}
                  >
          ...
          <div className="flex-1 min-w-0 space-y-6">
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <SectionCard title="Quick links" description="Navigate faster.">
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
                    <a className="flex flex-col items-center justify-center gap-2 rounded-2xl border border-primary-100 bg-primary-50/70 p-4 text-center hover:bg-primary-50 hover:shadow-md transition-all" href="#/smart-assistant">
                      <span className="text-sm font-black tracking-wider text-primary-700">GUIDE</span>
                      <span className="text-sm font-semibold text-slate-800">Smart Assistant</span>
                    </a>
                    <a className="flex flex-col items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white/50 p-4 text-center hover:bg-white hover:shadow-md transition-all" href="#/pricing">
                      <span className="text-2xl">💳</span>
                      <span className="text-sm font-semibold text-slate-800">Billing / Upgrade</span>
                    </a>
                    <a className="flex flex-col items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white/50 p-4 text-center hover:bg-white hover:shadow-md transition-all" href="#/renewals">
                      <span className="text-2xl">🔄</span>
                      <span className="text-sm font-semibold text-slate-800">Renewals</span>
                    </a>
                    <a className="flex flex-col items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white/50 p-4 text-center hover:bg-white hover:shadow-md transition-all" href="#/documents">
                      <span className="text-2xl">📄</span>
                      <span className="text-sm font-semibold text-slate-800">Documents</span>
                    </a>
                    <a className="flex flex-col items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white/50 p-4 text-center hover:bg-white hover:shadow-md transition-all" href="#/">
                      <span className="text-2xl">🏠</span>
                      <span className="text-sm font-semibold text-slate-800">Landing page</span>
                    </a>
                  </div>
                </SectionCard>
                ...
                <SectionCard title="Application tracking" description="Recent application tracking cards.">
                  <div className="mb-4">
                    <a
                      href="#/track"
                      className="inline-flex rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-bold text-slate-800 shadow-sm hover:bg-slate-50"
                    >
                      Track by ID
                    </a>
                  </div>
                    ...
                    <div className="grid gap-3">
                      {trackingRecords.map((record) => (
                        <a
                          ...
                          className="flex flex-col gap-2 rounded-2xl border border-slate-200 bg-white/60 p-4 hover:bg-white sm:flex-row sm:items-center sm:justify-between"
                        >
                          <div>
                            <div className="font-mono text-sm font-black text-slate-900">{record.trackingId}</div>
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                >
                  <div className="grid gap-6 md:grid-cols-3">
                    <div className="rounded-2xl border border-white/60 bg-white/50 p-5 shadow-sm">
                    ...
                    <div className="rounded-2xl border border-white/60 bg-white/50 p-5 shadow-sm">
                      <div className="text-xs font-bold uppercase tracking-wider text-slate-500">Current Plan</div>
                      <div className="mt-2 text-base font-semibold text-slate-900 flex items-center gap-2">
                        {isPremium ? (
                    ...
                    <div className="rounded-2xl border border-white/60 bg-white/50 p-5 shadow-sm">
                      <div className="text-xs font-bold uppercase tracking-wider text-slate-500">Account Status</div>
                      <div className="mt-2 text-base font-semibold text-emerald-600 flex items-center gap-2">
            ...
            {activeTab === 'renewals' && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                >
                  <div className="overflow-hidden rounded-2xl border border-white/60 bg-white/40 shadow-sm backdrop-blur-sm">
                    <div className="flex items-center justify-between bg-white/60 border-b border-white/60 px-5 py-4">
                      <div className="text-xs font-bold uppercase tracking-wider text-slate-600">Recent Applications</div>
                      <div className="text-xs font-bold uppercase tracking-wider text-slate-600">Status</div>
                    </div>
                    <div className="divide-y divide-white/60">
                      {(renewals || []).slice(0, 5).map((r) => (
                        <div key={r._id || r.id} className="flex items-center justify-between gap-4 px-5 py-4 hover:bg-white/40 transition-colors">
                      ...
                      {!renewals?.length ? (
                        <div className="px-5 py-10 text-center flex flex-col items-center">
                          <div className="grid size-16 place-items-center rounded-full bg-slate-100 text-slate-400 mb-4">
                          ...
                          <div className="text-sm font-semibold text-slate-900">No renewals found</div>
                          <div className="mt-1 text-sm text-slate-500">Start by applying for a new license or renewal.</div>
                          <a href="#/renewals" className="mt-4 rounded-xl bg-slate-900 px-5 py-2.5 text-sm font-bold text-white hover:bg-slate-800 transition-colors">Apply Now</a>
                        </div>
                      ) : null}
                    </div>
                  </div>
            ...
            {activeTab === 'documents' && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                >
                  ...
                  {uploadError ? (
                    <div className="mb-6 rounded-xl border border-rose-200 bg-rose-50/80 p-4 text-sm font-medium text-rose-700 backdrop-blur-sm">
                      {uploadError}
                    </div>
                  ) : null}

                  {uploading ? (
                    <div className="mb-6 rounded-xl border border-primary-200 bg-primary-50/80 p-4 text-sm font-bold text-primary-700 backdrop-blur-sm flex items-center gap-3">
                  ...
                  {documents.length ? (
                    <div className="overflow-hidden rounded-2xl border border-white/60 bg-white/40 shadow-sm backdrop-blur-sm">
                      <div className="flex items-center justify-between bg-white/60 border-b border-white/60 px-5 py-4">
                        <div className="text-xs font-bold uppercase tracking-wider text-slate-600">Recent Uploads</div>
                        <div className="text-xs font-bold uppercase tracking-wider text-slate-600">{documents.length} Files</div>
                      </div>
                      <div className="divide-y divide-white/60">
                        {documents.slice(0, 6).map((d) => (
                          <div key={d._id || d.id} className="flex items-center justify-between gap-4 px-5 py-4 hover:bg-white/40 transition-colors">
                            <div className="min-w-0 flex items-center gap-3">
                              ...
                              <div>
                                <div className="truncate text-sm font-bold text-slate-900">{d.original_name}</div>
                                <div className="mt-1 text-xs font-medium text-slate-500">
                            ...
                            <div className="shrink-0 flex items-center gap-3">
                              {d.imagekit_url ? (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noreferrer"
                                  className="rounded-xl border border-slate-200 bg-white px-3 py-1.5 text-xs font-bold text-slate-700 hover:bg-slate-50 hover:shadow-sm transition-all"
                                >
                                  View
                                </a>
                              ) : null}
                    ...
                    <div className="text-center py-8 text-sm font-medium text-slate-500">No documents uploaded yet.</div>
                  )}
                    </>
                  )}
                </SectionCard>
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  <LockedPanel locked={!isPremium} label="Premium">
                    <div className="p-8 bg-gradient-to-br from-indigo-50 to-white rounded-2xl border border-indigo-100">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                          <div className="text-lg font-bold text-slate-900">Premium Activated</div>
                          <div className="text-sm font-medium text-slate-500">You have access to all exclusive features.</div>
                        </div>
                      </div>
                      <ul className="space-y-4 text-sm font-medium text-slate-700">
                        <li className="flex items-center gap-3 bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
                          <div className="grid size-8 place-items-center rounded-full bg-emerald-100 text-emerald-600">✓</div>
                ...
                <SectionCard title="Download center" description="Generate and download data.">
                  <PremiumBlur locked={!isPremium}>
                    <div className="p-8 bg-white/50 rounded-2xl border border-white/60 shadow-sm">
                      <div className="flex items-start gap-4">
                        <div className="grid size-12 place-items-center rounded-2xl bg-slate-100 text-slate-600 shrink-0 border border-slate-200">
                          📊
                        </div>
                        <div>
                          <div className="text-base font-bold text-slate-900">Renewal Analytics Report</div>
                          <div className="mt-1 text-sm text-slate-600 leading-relaxed max-w-md">
                          ...
                          <button
                            type="button"
                            className="mt-6 inline-flex items-center justify-center gap-2 rounded-xl bg-slate-900 px-6 py-3 text-sm font-bold text-white shadow-md hover:bg-slate-800 transition-all hover:scale-105 active:scale-95 disabled:opacity-70 disabled:hover:scale-100"
    ...
    <div className="rounded-2xl border border-slate-200 bg-white/60 p-6 shadow-sm">
      <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
        <div className="max-w-xl">
          <div className="inline-flex items-center rounded-full border border-primary-100 bg-primary-50 px-3 py-1 text-xs font-bold uppercase tracking-wider text-primary-700">
            OTP Protected
          </div>
        ...
        <button
          ...
          onClick={onSendOtp}
          disabled={!!loading}
          className="rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-bold text-slate-800 shadow-sm hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60"
        >
      ...
      <form onSubmit={onVerify} className="mt-6 grid gap-4 md:grid-cols-[1fr_auto] md:items-end">
        <div>
          ...
          <input
            ...
            inputMode="numeric"
            placeholder="0000"
            className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-center text-2xl font-bold tracking-[0.4em] text-slate-900 outline-none transition focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10"
          />
        </div>
        <button
          type="submit"
          disabled={!canVerify || !!loading}
          className="rounded-xl bg-gradient-to-r from-primary-600 to-indigo-600 px-6 py-3 text-sm font-bold text-white shadow-md shadow-primary-500/20 hover:scale-105 disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:scale-100"
        >
