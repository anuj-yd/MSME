  ...
  return (
    <div className="relative min-h-dvh flex items-center justify-center bg-slate-50 overflow-hidden text-slate-900">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
        <div className="absolute -right-40 -top-40 h-[600px] w-[600px] rounded-full bg-indigo-300/20 blur-[120px]" />
        <div className="absolute -left-20 bottom-0 h-[500px] w-[500px] rounded-full bg-primary-400/15 blur-[120px]" />
      </div>
      ...
      <div className="relative mx-auto w-full max-w-[480px] px-6 py-12 z-10">
        ...
        <div className="rounded-[2rem] border border-white/60 bg-white/70 p-8 shadow-2xl shadow-slate-900/5 backdrop-blur-xl sm:p-10">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-slate-500">We'll send a 4-digit OTP to verify your email.</p>
          </div>
